...
function StageMedia({ record }: { record: DivisionRecord }) {
  if (!record.mediaUrl) {
    return <div className="stage-image" aria-hidden="true" />;
  }
  ...
  return (
    <div
      key={`${record.id}-${record.mediaUrl}`}
      className="stage-image has-image"
...
export function HomepageV190() {
  ...
  return (
    <main className="v190-shell" style={styleVars}>
