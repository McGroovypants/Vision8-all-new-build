...
export function PortfolioShell({
  ...
  eyebrow: string;
  // ReactNode, not string: a multi-sentence title needs to control its own line
  // breaks rather than wrap wherever the measure happens to run out.
  title: ReactNode;
  intro: string;
  heroImage?: string;
  className?: string;
